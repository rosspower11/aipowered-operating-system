...
type: skill
category: content
tags: [lead-magnet, email-list, opt-in, funnel, content]
ribbon: new
preview: Recommend and build a full lead magnet from a short interview about your audience and paid offer — checklist, guide, template, or mini-course, plus landing page copy and a launch post.
version: 1.0.0
author: AI Powered
created: 2026-06-05
updated: 2026-06-05
...
- You have an audience (followers, subscribers, community) but no email list
- You have a paid offer and need a freebie that actually converts into it
- You want a checklist, guide, template, or mini-course but don't know which format fits
- You need the full package: lead magnet, opt-in page copy, and a launch post

## When NOT to use this skill

- Building a paid product or course from scratch (use a course builder skill instead)
- Cold outreach prospect lists (use a prospecting tool instead)
- One-off social posts with no list-building goal
- Audiences with no paid offer yet — nail the offer first, then come back
...
Generate the full content as a .docx in the user's workspace folder. Use the docx skill if available in the environment.
...
- Link to the saved lead magnet .docx
